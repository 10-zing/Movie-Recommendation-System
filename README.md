...
Movie Recomendation System recommends movies similar to the movie user likes and analyses the sentiments on the reviews given by the user for that movie.
...
Source Code: https://github.com/10-zing/Movie-Recommendation-System/blob/main/main.py
